  ...
  return (
    <div>
      ...
      <Card title="About">
        ...
        >
          ✨ Built solo by <span style={{ color: "#fde9b8", fontWeight: 700 }}>Daniel Cañete</span>, with <span style={{ color: "#fde9b8", fontWeight: 700 }}>Claude</span> as coding assistant, reviewed by <span style={{ color: "#fde9b8", fontWeight: 700 }}>CodeRabbit</span>.
        </div>
      </Card>
    </div>
  );
